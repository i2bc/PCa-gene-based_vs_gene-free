...
/store/EQUIPES/SSFA/haoliang-shared/KaMRaT_for_Paper_Ha/PCa-gene-based_vs_gene-free/KaMRaT/bin/kamratReduce -d $smp_condition_path -N 2000 -m nb:5 $out_dir/raw-counts-merge-norm-TCGA-LRHR-3-10.tsv > $out_dir/top2k_contig_merge_norm.nb5.out
