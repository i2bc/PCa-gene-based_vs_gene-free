...
/store/EQUIPES/SSFA/haoliang-shared/KaMRaT_for_Paper_Ha/PCa-gene-based_vs_gene-free/KaMRaT/bin/kamratMerge -i mac -q mean -n -t $out_dir <(zcat $raw_count_path) > $out_dir/raw-counts-merge-TCGA-LRHR-3-10.tsv
